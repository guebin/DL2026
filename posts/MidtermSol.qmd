...
`(7)` 다음 두 네트워크 중 [$0 \sim 1$ 사이의]{style="color:red"} 더 복잡한 곡선을 적합할 수 있는 것은?
...
`(8)` [$0 \sim 1$ 사이의]{style="color:red"} 어떤 곡선 데이터를 위 `net_a`, `net_b` 로 적합한다고 하자. 데이터 수 $n$ 을 점점 키울 때 다음 중 옳은 것은? (학습률·epoch 충분히 적절히 가정)
